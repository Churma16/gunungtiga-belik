    ...
    <div class="card card-body blur shadow-blur mx-3 mx-md-4 mt-n6 mb-4">
        ...
        <section class="py-3">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <h3 class="mb-5 mt-5">SEJARAH DESA</h3>
                    </div>
                </div>
                <div class="row">
                    ...
                    <p class="text-lg mb-0">
                        ...
                        paths, choose the one more painful in
                        the short term (pain avoidance is
                        creating an illusion of equality).
                        Choose the path that leaves you more
                        equanimous. <br /><a href="javascript:;" class="text-info icon-move-right">More about me
                            ...
                            <div class="card-body">
                                <div class="content-left text-start my-auto py-4">
                                    ...
                                    <p class="card-description text-white">
                                        Rather than worrying about switching
                                        offices every couple years, you stay
                                        in the same place.
                                    </p>
                                ...
                                <div class="z-index-2 text-center d-flex h-100 w-100 d-flex m-auto justify-content-center">
                                    ...
                                    <div class="p-5 ps-sm-8 position-relative text-start my-auto z-index-2">
                                        ...
                                        <div class="d-flex p-2 text-white">
                                            ...
                                            <div class="ps-3">
                                                <span class="text-sm opacity-8">Dyonisie Wolf
                                                    Bucharest, RO
                                                    010458</span>
                                            </div>
                                        </div>
