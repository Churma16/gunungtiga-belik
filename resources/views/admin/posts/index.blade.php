                ...
                <div class="col-12">
                    <div class="card my-4">
                        ...
                        <div class="d-flex px-3 pt-2">
                            <a class="btn btn-primary" href="/posts/create"><i
                                class="fas fa-plus"></i> <small>Buat Postingan</small></a>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        @else
                                            @foreach ($posts as $post)
                                                <tr>
                                                    <td class="">
                                                        <span class="text-secondary  text-xs font-weight-bold ps-4">{{ $loop->iteration }}</span>
                                                    </td>
                                                    <td class="align-middle text-center" style="max-width: 50px">
                                                        <img src="{{ asset('storage/' . $post->gambar) }}"
                                                                class="me-3" alt="user1" width="100%"
                                                        />
                                                    </td>
